...
export default Ember.View.extend({
  didInsertElement: function() {
    ...
    var mainNav = Ember.$('.main-nav > ul'),
      pushy = Ember.$('.off-canvas-nav'), //menu css class
      body = Ember.$('body'),
      container = Ember.$('#site-content'), //container css class
      push = Ember.$('.push'), //css class to add pushy capability
      siteOverlay = Ember.$('.site-overlay'), //site overlay
